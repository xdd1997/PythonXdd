...
class MyPyQT_Form(QtWidgets.QWidget, Ui_Form):
    ...
    def initUI(self):  # 定义初始化界面的方法
        ...
        self.time2 = QTimer(self)    # 设置第2个计时器用以事件提醒
        self.time2.setInterval(1000)
        self.time2.timeout.connect(self.refresh2)
        self.time2.start()

        self.time3 = QTimer(self)    # 设置第3个计时器用以正计时
        ...
        if checkbox1val == '1':  # 勾选了默认窗口
            ...
            if L == 1:
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    self.txtShow = '温馨提示：' + hmTPlist[0][2]
            ...
            if L == 2:
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    self.txtShow = '温馨提示：' + hmTPlist[1][2]
                else:
                    endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                    self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：距离.今天结束'
            ...
            if L == 3:  # 有三件事
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    self.txtShow = '温馨提示：' + hmTPlist[2][2]
                else:
                    endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                    self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：距离.今天结束'
            ...
            if L == 4:
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    if p4 == '每天':
                        ...
                        endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                        self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：' + hmTPlist[3][2]
                else:
                    endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                    self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：距离.今天结束'
            if L == 5:
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    if p5 == '每天':
                        ...
                        str1 = '距离' + hmTPlist[4][2] + '还有'
                        self.label_eatTxt.setText(str1)
                        self.txtShow = '温馨提示：' + hmTPlist[4][2]
                    else:
                        endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                        self.label_eatTxt.setText('距离今天结束')
                        self.txtShow = '温馨提示：距离.今天结束'
            ...
            if L == 6:
                ...
                if (((hour == h1) & (minute < m1)) | (hour < h1)):
                    ...
                    if p6 == '每天':
                        ...
                        endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                        self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：' + hmTPlist[5][2]
                else:
                    endDate = QDateTime(QDate(year, mount, day), QTime(23, 59, 59)).toMSecsSinceEpoch()
                    self.label_eatTxt.setText('距离今天结束')
                    self.txtShow = '温馨提示：' + hmTPlist[5][2]
    ...
    def ShowZhuCeFig(self):
        ...
        b1 = tk.Button(window, text='注册', bg='lightblue', width=7, height=1, font=('微软雅黑', 10),
                       command=self.ZhuCeBtn).place(x=30, y=150)  # 方法要在这条语句前面
        b2 = tk.Button(window, text='清空', bg='lightblue', width=7, height=1, font=('微软雅黑', 10),
                       command=self.ZhuCeclean).place(x=120, y=150)  # 方法要在这条语句前面
        b3 = tk.Button(window, text='帮助', bg='lightblue', width=7, height=1, font=('微软雅黑', 10),
                       command=self.ZhuCehelp).place(x=210, y=150)  # 方法要在这条语句前面
...
class winSetup(QtWidgets.QWidget, UISetup):
    ...
    def btn_save_click(self):
        ...
        txt1 = self.lineEdit_set1.text();
        time1 = self.timeEdit_1.text();
        box1 = self.comboBox_1.currentText()
        txt2 = self.lineEdit_set2.text();
        time2 = self.timeEdit_2.text();
        box2 = self.comboBox_2.currentText()
        txt3 = self.lineEdit_set3.text();
        time3 = self.timeEdit_3.text();
        box3 = self.comboBox_3.currentText()
        txt4 = self.lineEdit_set4.text();
        time4 = self.timeEdit_4.text();
        box4 = self.comboBox_4.currentText()
        txt5 = self.lineEdit_set5.text();
        time5 = self.timeEdit_5.text();
        box5 = self.comboBox_5.currentText()
        txt6 = self.lineEdit_set6.text();
        time6 = self.timeEdit_6.text();
        box6 = self.comboBox_6.currentText()
        list1 = [time1, '***', txt1, '***', box1];
        list2 = [time2, '***', txt2, '***', box2];
        list3 = [time3, '***', txt3, '***', box3];
        list4 = [time4, '***', txt4, '***', box4];
        list5 = [time5, '***', txt5, '***', box5];
        list6 = [time6, '***', txt6, '***', box6];
