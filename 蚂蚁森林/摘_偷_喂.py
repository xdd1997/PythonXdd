...
if len(items) > 14:
    for i in items:
        if '能量' in i.text:
            ...
            time.sleep(1)
time.sleep(1)
driver.tap([(50, 130), (70, 150)], 100) # 左上角返回键的位置
time.sleep(1)
...
time.sleep(2)
TouchAction(driver).press(x=400, y=1477).release().perform()    # 点小鸡 01
time.sleep(2)
TouchAction(driver).press(x=257, y=1267).release().perform()    # 请走小鸡 01
time.sleep(2)
